...
#OrlykArticle .content > .row::after {
  content: "";
  clear: both;
  display: block;
}

#OrlykArticle .content > .row > .leftCol {
  width: 30%;
  float: left;
}

#OrlykArticle .content > .row > .rightCol {
  width: 70%;
  float: left;
}
</style>
